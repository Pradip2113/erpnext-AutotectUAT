...
class QualityInspection(Document):
			...
			for reading in self.readings:
				for d in parameters:
					if reading.specification == d.specification:
						...
						reading.reading_value = d.reading_value
	...
	def get_item_specification_details(self):
		...
		for d in parameters:
			...
			temp = self.quality_inspection_template
			quality_inspection_temp = frappe.get_doc("Quality Inspection Template", temp)
			items_table = quality_inspection_temp.get("item_quality_inspection_parameter")
			for j in items_table:
				for k in self.get('readings'):
					if k.specification == j.specification:
						k.reading_value=j.reading_value
