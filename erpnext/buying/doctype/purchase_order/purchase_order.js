		...
		this.frm.add_custom_button(__('Material Request'),
			function() {
				erpnext.utils.map_current_doc({
					...
					child_columns: ["item_code", "description", "qty","uom","ordered_qty"]
				});	
				const filteredItems = me.frm.doc.items = me.frm.doc.items.filters(item => item.ordered_qty > 0);
				debugger
				me.frm.doc.items = filteredItems;
			}, __("Get Items From"));
